...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="{{route('viewform')}}">Add Item</a>
              </li>
              <li class="nav-item">
    ...
    <form action="{{route('create')}}" method="POST" class="content" enctype="multipart/form-data">
      @csrf
      <h2>Pendataan Barang Baru</h2>
      <div class="mb-3">
